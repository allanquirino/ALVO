...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-background via-graphite to-background" />
      ...
      <div className="relative z-10 container-luxury text-center px-6">
        ...
        >
          <span className="block text-foreground">Elegância</span>
          <span className="block text-gradient font-medium">Redefinida</span>
        </motion.h1>

        <motion.p
          className="max-w-xl mx-auto text-lg text-muted-foreground font-light leading-relaxed mb-12"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.6 }}
        >
          Descubra peças exclusivas que transcendem o tempo. 
          Qualidade premium, design atemporal.
        </motion.p>
